        ...
        <div class="l-wrap">
          ...
          <div class="c-about__about__cnt">
            <div class="c-about__about__connect">
              ...
              <ul class="ul">
                <li class="li">{{initdata.about.content.site.title}}&nbsp;:&nbsp;{{initdata.about.content.site.text}}
                </li>
                <li class="li">
                  {{initdata.about.content.phone.title}}&nbsp;:&nbsp;{{initdata.about.content.phone.text}}
                </li>
                <li class="li">{{initdata.about.content.fax.title}}&nbsp;:&nbsp;{{initdata.about.content.fax.text}}</li>
                <li class="li">
                  {{initdata.about.content.email.title}}&nbsp;:&nbsp;{{initdata.about.content.email.text}}
                </li>
              </ul>
            </div>
